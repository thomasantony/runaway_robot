...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER = None):
    ...
    if len(OTHER) < 3:
        ...
        target_next_pos = [x + v*cos(theta),
                           y + v*sin(theta)]

        heading_to_target = get_heading(hunter_position, target_next_pos)
        heading_difference = heading_to_target - hunter_heading
        turning =  heading_difference # turn towards the target
        distance = distance_between(target_next_pos, hunter_position)
...
def demo_grading2(hunter_bot, target_bot, next_move_fcn, OTHER = None):
    ...
    while not caught and ctr < 1000:
        ...
        #     print('Move : '+str((distance, turning*180/pi)))
        #     print()
